...
info_log "Puppet installation started"
...
# Install puppet master
        ...
        ${APT} install puppetmaster=3.6.0-1puppetlabs1 puppet-common=3.6.0-1puppetlabs1 puppetmaster-common=3.6.0-1puppetlabs1 -y && print_ok || print_error "Failed to install puppet master."
...
exit 0
info_log "Puppet installation completed successfully"
